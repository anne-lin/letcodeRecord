...
webAgent.prototype.loadMainScrip = function(initParams){
    ...
    qnTool.loadScript((devMode ? "/main.js" : "/main.min.js") + "?" + WebAgent.version["BUILD-DATE"] + "_" + WebAgent.version["GIT-Revision-SHORT"])
    .then(function(){
        WebAgent.WaParams = initParams.WaParams;
        return qnTool.loadScript((devMode ? "/WA/main.js" : "/WA/main.min.js") + "?" + WebAgent.version["BUILD-DATE"] + "_" + WebAgent.version["GIT-Revision-SHORT"]);
    })
    .then(function(){
    ...
    .then(function(){
        ...
        return qnTool.loadScript((devMode ? "/Agent/main.js" : "/Agent/main.min.js") + "?" + WebAgent.version["BUILD-DATE"] + "_" + WebAgent.version["GIT-Revision-SHORT"]);
    }).then(function(){
        setTimeout(()=>{
            initParams.callback && initParams.callback();
        },3000)
    })
}